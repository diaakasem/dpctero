    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', audit_log.models.fields.CreatingUserField(related_name='created_hash_hash_set', editable=False, to=settings.AUTH_USER_MODEL, null=True, verbose_name='created by')),
                ('modified_by', audit_log.models.fields.LastUserField(related_name='modified_hash_hash_set', editable=False, to=settings.AUTH_USER_MODEL, null=True, verbose_name='modified by')),
            ],
            options={
                'verbose_name': 'Hash',
